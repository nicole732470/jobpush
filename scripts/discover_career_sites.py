...
EXCLUDED_DOMAINS = {
    ...
    "internshala.com", "localjobs.sulekha.com", "johngannonblog.com",
    "jobs.chronicle.com", "us.fashionjobs.com", "capd.mit.edu",
    "climatechangecareers.com", "entertainmentcareers.net", "au.seek.com",
    "gulftalent.com", "employer.practicematch.com", "migratemate.co",
    "usnlx.com", "jobs-redefined.co",
...
def classify_url(raw_url):
    ...
    canonical_url = urlunparse((parsed.scheme or "https", netloc, canonical_path, "", "", ""))
