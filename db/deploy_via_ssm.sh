...
if [[ -d "$REPO_DIR/scripts" ]]; then
  ...
  for script in \
    ...
    crawl_oracle_cloud.py crawl_workday.py crawl_lever.py crawl_ashby.py crawl_jobvite.py crawl_jobscore.py crawl_dover.py crawl_paylocity.py crawl_rippling.py \
