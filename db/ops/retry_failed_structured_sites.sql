...
-- After adapter URL handling fixes, retry failed structured ATS sites quickly.
-- Do not touch human-rejected or disabled rows.
...
WHERE target.consolidation_key = site.consolidation_key
  ...
  AND site.source_type IN ('workday', 'greenhouse', 'ashby', 'lever', 'smartrecruiters');
