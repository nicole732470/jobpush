...
for row in "${DUE_SITES[@]}"; do
  ...
  case "$source_type" in
    ...
    jobscore)
      adapter_name="jobscore-html"; adapter_version="0.1.0"; adapter_script="scripts/crawl_jobscore.py" ;;
    applicantpro)
    ...
    gusto)
      adapter_name="gusto-board-html"; adapter_version="0.1.0"; adapter_script="scripts/crawl_gusto_jobs.py" ;;
    icims)
