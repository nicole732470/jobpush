...
WITH candidate_rollup AS (
    ...
    SELECT
        ...
        CASE
            WHEN target.priority_source = 'manual_override' AND target.priority_tier = 'P0'
                THEN 'manual_p0'
...
COMMENT ON VIEW jobpush.career_site_review_workbench IS
    'Canonical human review surface: one company per row, P0/potential-P0 first, pending and verified together.';
