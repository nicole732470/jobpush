...
SELECT
    ...
    canonical_role,
               ...
               CASE
                   ...
                   WHEN normalized_title LIKE '%program%manager%'
                        OR normalized_title LIKE '%technical program manager%' THEN 'program_manager'
                   WHEN normalized_title LIKE '%project%manager%'
                        OR normalized_title LIKE '%technical project manager%'
                        OR normalized_title LIKE '%it project manager%' THEN 'project_manager'
                   WHEN normalized_title LIKE '%product%manager%'
                        AND normalized_title NOT LIKE '%production%manager%'
                        AND normalized_title NOT LIKE '%product marketing manager%' THEN 'product_manager'
               ...
               CASE
                   ...
                   WHEN normalized_title LIKE '%new grad%'
                        ...
                        OR normalized_title LIKE '%recent grad%' THEN 'new_grad'
